...
% job title/career
\cvjobtitle{Jr. Software Developer}
% date of birth
\cvbirthday{Jan 2, 1998}
% short address/location, use \newline if more than 1 line is required
\cvaddress{Park Ave.~1, 555 555 B-Woods}
% phone number
\cvgithub{www.github.com/rhofp}
\cvlinkedin{www.linkedin.com/rodrigo-fp}
...
\addtofrontsidebar{
    ...
    \barskill{\faCode}{PHP}{40}
  	\barskill{\faCode}{Swift}{20}
    ...
    \pointskill{\faDesktop}{Laravel}{3}
    ...
    \pointskill{\faDesktop}{Unity}{2}
    \pointskill{\faDesktop}{Oracle SQL}{4}
    \pointskill{\faDesktop}{Laravel}{4}
...
\begin{cvtable}
	\cvitem{currently}{Part time Web Developer}{Ludomatics}{Focused on creating educational
...
\begin{cvtable}
  ...
  \cvitem{2017}{\textbf{Networking}. Principles for understanding how our network works }{PROTECO}{}
	\cvitem{2020}{\textbf{iOS}. \textit{Currently} I'm taking the iOS development package course, it includes basic, intermediate and advancedlevels.}{PROTECO}{}
\end{cvtable}
...
\begin{cvtable}
  ...
  \cvitem{2019}{Root Brain}{http://github.com/rhof/root-brain}{Root brain is multiplatform app that my friends and I developed to promote some science information about the brain. I was all implemented in Unity }
\end{cvtable}
...
\cvsection{Awards}
\begin{cvtable}
	\cvitem{2019}{App development contest 'Aplica la ciencia' second place}{SOMEDICYT}{}
\end{cvtable}
