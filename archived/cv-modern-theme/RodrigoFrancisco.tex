\documentclass[]{friggeri-cv-theme}
...
\usepackage{calc}
\usepackage{enumitem}                       % to customize indent of 
                                            % bullet points via \itemize
\usepackage{metalogo}
\usepackage{dtklogos}
...
\smartdiagramset{
    ...
    % specifies which is the distance among the bubble center node and the 
    % other bubbles
    ...
    set color list = {bubblegray, bubblegray, bubblegray, bubblegray,
    bubblegray, white, lightgray, lightgray, lightgray, lightgray},
...
% you can change ipsgreen to any color you like, but you´ll also have to change
% it in the reccius-cv-experiment.cls file
